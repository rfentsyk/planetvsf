...
```sh
grep -rl 'planetvsf' ./ | xargs sed -i '' 's/planetvsf/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with planetvsf
...
Want to contribute? Ping us on `planetvsf` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/planetvsf.git
    cd planetvsf
    ```
...
- [planetvsf integration Documentation](https://docs.vuestorefront.io/planetvsf)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `planetvsf` channel on [our Discord](discord.vuestorefront.io).
